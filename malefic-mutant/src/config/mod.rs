...
pub struct BasicConfig {
    ...
    pub key: String,
    pub retry: u32, // Number of register retry attempts per target
    #[serde(default = "default_max_failures")]
    pub max_failures: Option<u32>, // Number of session failures before skipping target
...
fn default_max_failures() -> Option<u32> {
    Some(10)
}
