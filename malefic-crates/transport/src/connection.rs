...
pub struct Connection {
    ...
    deadline: Duration,
    supports_duplex_keepalive: bool,
}
...
impl Connection {
    pub fn new(
        ...
        Self::new_with_duplex_keepalive(
            transport,
            cryptor,
            session_id,
            encrypt_key,
    ...
    pub fn new_with_duplex_keepalive(
        transport: InnerTransport,
        cryptor: Cryptor,
        session_id: [u8; 4],
        encrypt_key: Option<&str>,
        ...
        Self {
            ...
            deadline,
            supports_duplex_keepalive,
        }
    }

    pub fn supports_duplex_keepalive(&self) -> bool {
        self.supports_duplex_keepalive
    }
...
impl ConnectionBuilder {
    pub fn new(transport: InnerTransport) -> Self {
        Self {
            ...
            supports_duplex_keepalive: true,
        }
    }
    ...
    pub fn with_duplex_keepalive(mut self, supports_duplex_keepalive: bool) -> Self {
        self.supports_duplex_keepalive = supports_duplex_keepalive;
        self
    }
    ...
    pub fn build(self) -> Result<Connection, BuildError> {
        ...
        Ok(Connection::new_with_duplex_keepalive(
            transport,
            cryptor,
            session_id,
